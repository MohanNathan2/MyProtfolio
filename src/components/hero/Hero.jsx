...
import resumePDF from "../../assets/MohanResumeNew.pdf";
      ...
      <div className=" container mx-auto pt-5 h-[750px] md:h-[100vh] md:flex-col-reverse sm:h-[780px]  flex sm:flex-col-reverse sm:pt-0 ">
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          ...
          <div className="icons flex mt-5">
            ...
            >
              <li>
                <a href="https://github.com/MohanNathan2">
                  {" "}
                  <AiFillGithub className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125" />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/mohan-nathan-129722169/">
                  {" "}
                  <FaLinkedinIn className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125 " />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/_mohan_nathan/">
                  {" "}
        ...
        <div className="right  top-5 flex-1 flex items-center justify-center md:items-end sm:items-end">
          <div className="relative h-[88%] w-fit flex items-center sm:items-end">
            <img
            data-aos="fade-up"
              className="your-element  h-[90%]  w-full object-cover md:h-[95%] md:m-auto sm:m-0"
              src='https://i.postimg.cc/Kz5TnTrz/mohan1.png'
              // src={mine}
              alt="mine"
              style={{ backgroundColor: "#ffff74", borderRadius: "40%" }}
            ...
            <div className=" absolute bottom-10 md:bottom-3 right-8 md:right-2">
              <div data-aos="zoom-in" data-aos-duration="1000"  className=" relative cursor-pointer">
                <img
                  ...
                  src="https://i.postimg.cc/BQGmxWW7/Full-Stack-Developer2.png"
                  alt=""
                  />
                <FaPlay
